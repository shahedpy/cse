...
- Regression Models: Linear Regression (Simple & Multiple), Polynomial Regression, Ridge & Lasso Regression
- Decision Tree: Iterative Dichotomize 3 (ID3) Algorithm, Measure of similarity, data normalization, k-NN: Introduction
- Classification Models: Weighted K-NN algorithm, K-dimensional tree algorithm
